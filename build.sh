...
java -jar ckbuilder/$CKBUILDER_VERSION/ckbuilder.jar --build ckeditor build/$1 $skip --version="4.0.3 ($name)" --revision $rev --build-config presets/$1-build-config.js --overwrite "$@"
